...
#read movie data
movies = pd.read_csv(r"C:\Users\User\Desktop\ml-latest-small\movies.csv")
movies.columns
movies.drop('title', axis = 1, inplace = True)
df = pd.read_csv(r"C:\Users\User\Desktop\ml-latest-small\ratings.csv")
...
#為user1找出最相似的10部影片
print(list(get_the_most_similar_movies(2, user_movie_matrix, 10)))


#為movie1找出最相似的10個用戶
print(list(get_the_most_similar_users(1, user_movie_matrix, 10)))
